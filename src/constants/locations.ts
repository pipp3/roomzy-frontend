...
export type Region = keyof typeof REGIONS_AND_CITIES;
export type City<T extends Region> = typeof REGIONS_AND_CITIES[T][number];

// Función helper para obtener las ciudades de una región
export const getCitiesByRegion = (region: Region): readonly string[] => {
  return REGIONS_AND_CITIES[region] || [];
};

// Array de todas las regiones
export const REGIONS = Object.keys(REGIONS_AND_CITIES) as Region[]; 