...
import { adminService, AdminUser, UpdateUserData } from '@/services/adminService';
import { 
  ArrowLeft,
  Save,
  User,
    ...
    try {
      ...
      if (response.success && response.data) {
        ...
        setFormData({
          ...
          city: userData.city,
          phone: userData.phone.startsWith('+56') ? userData.phone.slice(3) : userData.phone,
          role: userData.role as 'admin' | 'seeker' | 'host',
          bio: userData.bio || '',
          habits: userData.habits || '',
          isEmailVerified: userData.isEmailVerified,
        });
        
        // Cargar ciudades disponibles para la región actual
        if (userData.region) {
          const cities = CHILE_REGIONS_CITIES[userData.region as keyof typeof CHILE_REGIONS_CITIES] || [];
